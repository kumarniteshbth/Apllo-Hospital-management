document.addEventListener('DOMContentLoaded', function() {
    ...
    const doctorsData = [
        ...
        {
            name: "Dr. Conrad Hawkins",
            specialty: "Senior Resident",
            bio: "Dr. Conrad Hawkins is introduced as a tough, brilliant and cocky senior resident, who supervises an idealistic young doctor.",
            image: "OIP (2).jpg"
        }
    ];
